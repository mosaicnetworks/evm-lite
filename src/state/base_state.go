...
func (bs *BaseState) WriteTransactions(txs map[common.Hash]*ethTypes.Transaction) error {
...
func (bs *BaseState) WriteReceipts(receipts map[common.Hash]*ethTypes.Receipt) error {
	batch := bs.db.NewBatch()
